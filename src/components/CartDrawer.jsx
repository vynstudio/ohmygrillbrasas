    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, fontWeight: 600, color: '#1A1500', margin: 0 }}>
              Tu pedido
            </h2>
            {itemCount > 0 && (
          ...
          {itemCount === 0 ? (
            ...
            <>
                ...
                {items.map(item => (
                  <div key={item.id} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
                      ...
                      <button onClick={() => updateQty(item.id, item.qty + 1)} style={{
                        width: 26, height: 26, border: 'none', background: '#1A1500',
                        borderRadius: '50%', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontSize: 14, color: '#fff', fontWeight: 500,
                      }}>+</button>
                    </div>
                    <span style={{ fontFamily: "'Fraunces', serif", fontSize: 15, fontWeight: 600, color: '#1A1500', minWidth: 48, textAlign: 'right' }}>
              ...
              <div style={{ marginBottom: 16 }}>
                <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 12, fontWeight: 500, color: '#1A1500', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.8px' }}>
                  Tipo de entrega
                </p>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <select
                    ...
                    style={{
                      ...
                      fontSize: 13, color: '#1A1500', cursor: 'pointer',
                    }}
                  >
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <textarea
                  ...
                  style={{
                    width: '100%', padding: '10px 12px', border: '1px solid #D4CFC9',
                    borderRadius: 10, background: '#fff', fontFamily: "'Outfit', sans-serif",
                    fontSize: 13, color: '#1A1500', resize: 'vertical', boxSizing: 'border-box',
                  }}
                />
              </div>
            </>
        ...
        {itemCount > 0 && (
          <div style={{ padding: '16px 24px', borderTop: '1px solid #F0E4C8', background: '#fff' }}>
            ...
            <button
              ...
              style={{
                width: '100%', padding: '14px', background: '#1A1500', color: '#fff',
