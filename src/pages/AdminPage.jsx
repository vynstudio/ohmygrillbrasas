...
function MenuEditor() {
  ...
  if (loading) return (
    <div style={{ textAlign: 'center', padding: '48px 20px', color: '#9A8F85' }}>
      <div style={{ width: 32, height: 32, border: '3px solid #EDE9E3', borderTopColor: '#ffd43a', borderRadius: '50%', animation: 'spin 0.8s linear infinite', margin: '0 auto 12px' }} />
